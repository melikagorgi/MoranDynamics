...
x=0:0.01:1;
v_3 = 2*sqrt(2.*abs(qA)).*ones(1,length(c_ave_bd(1:K:T-dt)));
v_2 = 2*sqrt(2.*abs(qA)).*ones(1,length(c_ave_fk(1:K:T-dt)));
v_1 = 2*sqrt(2.*abs(qA)./(1-abs(qA).*c_ave_db(1:K:T-dt)).^2);
